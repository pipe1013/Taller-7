...
<main class="form-signin w-100 m-auto">
    <form action="registerUser" method="post">
        ...
        <div class="form-floating">
            <input type="text" class="form-control" name="product_name" id="floatingproduct" placeholder="ingrese el nombre de su  producto" required autofocus pattern="{60}">
            <label for="floatingproduct">Nombre del producto:</label>
        </div>
        <div class="form-floating">
            <input type="number" name="product_value" class="form-control" id="floatingvalue"
                   placeholder="ingrese el precio" required pattern="{60}">
            <label for="floatingvalue">Precio del producto:</label>
        </div>

        <div class="form-floating">
            <input type="number" name="category_id" class="form-control" id="floatingId"
                   placeholder="ingrese su categoria" required pattern="{60}">
            <label for="floatingId">Categoría:</label>
        </div>
